...
export default function OptionD({ isDesktop }) {
              ...
              >
                ...
                {key === 'new' ? (
                  ...
                  <MegaMenu
                    open={activeMenu === key}
                    onClose={() => setActiveMenu(null)}
                    columns={optionDDesktopMenus[key].columns}
                    width={optionDDesktopMenus[key].width}
                  />
                )}
              </div>
            ))}
  ...
  return (
    <>
      ...
      <MobileMenu
        ...
        sections={optionDMobileSections}
        footerLinks={optionDFooterLinks}
      />
    </>
  );
}
